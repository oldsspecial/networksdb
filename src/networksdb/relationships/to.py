"""Generated relationship model for TO."""
...
class To(BaseRelationship, IDGenerationMixin):
    """TO relationship type.
    
    Valid node pairs:    - Email -> EmailAddress    """
    
    # Class attributes
    _rel_type: ClassVar[str] = "TO"
    schema_version: ClassVar[str] = "0.1"
    _valid_pairs: ClassVar[list[tuple[str, str]]] = [        ("Email", "EmailAddress"),    ]
